                                                                                ...
                                                                                <td class="">
                                                                                    <div class="btn-group dropdown">
                                                                                        ...
                                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                                            <a class="dropdown-item" href="../saas/doc_file/<?= $value['file_path']; ?>" download="../saas/<?= $value['file_path']; ?>"><i class="mdi mdi-download me-2 text-muted vertical-middle"></i>Download</a>
