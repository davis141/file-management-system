                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $s_sql = "SELECT ad.id, ad.date, ad.file_path,f.file_name, u.full_name, c.category_name FROM admin_share ad JOIN file_table f ON ad.file_id = f.id JOIN user u ON ad.shared_admin = u.user_id JOIN category c ON ad.company_id = c.company_id WHERE ad.user_id = '$user_id' AND ad.company_id = '$c_id' AND  f.to_admin = TRUE AND f.status = FALSE";
