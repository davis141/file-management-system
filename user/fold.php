                                        ...
                                        <div class="mt-3">
                                            <div class="table-responsive">
                                                <table class="table table-centered table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $s_sql = "SELECT `file_name`, `file_path`, `date_time` FROM `file_table` WHERE `folder_id` = '$folder_id'";
                                                        $fetch_query = $app->fetch_query($s_sql);
                                                        foreach ($fetch_query as $value) {
                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <img src="assets/images/file.png" class="me-1"><span class="ms-2 fw-semibold text-secondary"><?php echo $value['file_name'] ?></span>
                                                                </td>
                                                                <td><span class="fw-semibold text-secondary"><?php echo $value['date_time'] ?></span></td>
                                                                <td class="">
