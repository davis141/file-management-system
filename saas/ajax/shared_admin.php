...
if (isset($file_name)) {
    $query = "INSERT INTO `admin_share` (`id`, `file_id`, `shared_admin`, `added_input`, `user_id`,`company_id`, `file_path`)
    VALUES (NULL, '$file','$shr','$file_name','$user_decoded','$c_ids',(SELECT file_path FROM file_table WHERE id = '$file'))";
