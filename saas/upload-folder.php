                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="page-aside-right">
                                        ...
                                        <div class="mt-3">
                                            <h5 class="mb-2">Create Folder</h5>
                                        </div>
                                        <div class="mt-3">
                                            <form method="post" name="myForm" id="myForm">
                                                ...
                                                <button type="submit" class="btn btn-primary mt-2" id="reset-btn"><i class="ri-upload-2-fill me-2 fs-5"></i>Create</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
